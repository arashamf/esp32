...
void st7735SetAddrWindow(spi_device_handle_t spi, unsigned char x0, unsigned char y0, unsigned char x1, unsigned char y1);
unsigned short lcdGetWidth(void);
unsigned short lcdGetHeight(void);
void lcdFillRGB (spi_device_handle_t spi, unsigned short color);
